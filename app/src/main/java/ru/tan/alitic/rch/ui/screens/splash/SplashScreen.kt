package ru.tan.alitic.rch.ui.screens.splash
...
import ru.tan.alitic.rch.domain.grey.LoadingState
import ru.tan.alitic.rch.navigation.ScreenRoutes
import ru.tan.alitic.rch.ui.elements.Background
import ru.tan.alitic.rch.ui.elements.MorphingShapeLoadingAnimation
    ...
    LaunchedEffect(state) {
        when (state) {
            LoadingState.InitState -> {
                splashViewModel.load(context, "ky40aq4j54ao")
            }
