package com.sb.er.act.iv.ui.screens.splash
...
import com.sb.er.act.iv.domain.grey.LoadingState
import com.sb.er.act.iv.navigation.ScreenRoutes
import com.sb.er.act.iv.ui.elements.Background
import com.sb.er.act.iv.ui.elements.BallScaleMultipleIndicator
    ...
    LaunchedEffect(state) {
        when (state) {
            LoadingState.InitState -> {
                splashViewModel.load(context,"26gou0jc1v9c")
            }
