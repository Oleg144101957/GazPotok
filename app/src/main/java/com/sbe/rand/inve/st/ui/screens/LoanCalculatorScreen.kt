package com.sbe.rand.inve.st.ui.screens
...
import com.sbe.rand.inve.st.ui.elements.CustomOutlinedTextField
import com.sbe.rand.inve.st.ui.elements.IconButton
import com.sbe.rand.inve.st.util.lockOrientation
import kotlin.math.pow

@Composable
fun LoanCalculatorScreen(navController: NavController, innerPadding: PaddingValues) {
...
fun calculateLoanTotalPayment(amount: Double?, rate: Double?, months: Int?): Double? {
    if (amount == null || rate == null || months == null || months == 0) return null
    ...
    return if (monthlyRate == 0.0) {
        ...
        val monthlyPayment =
            amount * monthlyRate / (1 - (1 + monthlyRate).pow(-months.toDouble()))
